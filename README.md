## You can download the source code from https://www.asix.com.tw/en/product/USBEthernet/Super-Speed_USB_Ethernet/AX88179A
...
and so, go to the driver directory and execute the following command:
	$sudo ./ax88179a_programmer reload
